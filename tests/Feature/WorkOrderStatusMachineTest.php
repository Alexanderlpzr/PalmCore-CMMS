...
it('draft can transition to planned or cancelled', function () {
    $status = WorkOrderStatus::Draft;

    expect($status->canTransitionTo(WorkOrderStatus::Planned))->toBeTrue()
...
it('in_progress can transition to on_hold, completed, or cancelled', function () {
    ...
    expect($status->canTransitionTo(WorkOrderStatus::OnHold))->toBeTrue()
        ...
        ->and($status->canTransitionTo(WorkOrderStatus::Cancelled))->toBeTrue()
        ->and($status->canTransitionTo(WorkOrderStatus::Closed))->toBeFalse();
});
...
it('completed can go to verified or back to in_progress', function () {

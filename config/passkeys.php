...
return [
    ...
    */
    ...
    // Root domain so passkeys work across all subdomains ({tenant}.palmcore.app).
    // WebAuthn allows RP ID to be an ancestor of the request origin.
    // In local dev, falls back to parsing APP_URL so localhost still works.

        ...
        return () => h(RouterLink,
            {
                ...
                class: `flex flex-col items-center justify-center gap-1 flex-1 py-2 px-1 text-xs font-medium transition-colors ${isActive.value ? 'text-emerald-600' : 'text-gray-500'}`,
            },
            () => [
                h('svg', {
                    class: 'w-5 h-5',

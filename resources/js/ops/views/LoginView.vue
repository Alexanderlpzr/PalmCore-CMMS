    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-950 px-4 py-12">
        <div class="w-full max-w-sm">
            ...
            <div class="flex flex-col items-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-white tracking-tight">PAJUIL CMMS</h1>
            ...
            <p class="text-center text-xs text-slate-500 mt-6">PAJUIL CMMS &copy; {{ new Date().getFullYear() }}</p>
        </div>
    </div>
</template>

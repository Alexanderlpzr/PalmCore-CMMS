                    ...
                    <div class="flex items-center gap-2">
                        @if ($row['filled'])
                            ...
                            <input
                                ...
                                step="0.1"
                                min="0"
                                wire:key="round-cell-{{ $row['reading_id'] }}-{{ $row['reading'] }}"
                                x-data="{ v: @js((string) $row['reading']) }"
                                x-model="v"
                                x-on:keydown.enter.prevent="$wire.saveEditedReading(@js($row['reading_id']), v)"
                                x-on:blur="$wire.saveEditedReading(@js($row['reading_id']), v)"
                        ...
                        @else
                            <input
                                ...
                                step="0.1"
                                min="0"
                                wire:key="round-empty-{{ $row['id'] }}-{{ $periodKey }}"
